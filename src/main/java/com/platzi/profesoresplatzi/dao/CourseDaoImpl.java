...
public class CourseDaoImpl extends AbstractSession implements CourseDao {
	...
	public Course findByName(String name) {
		...
		return (Course)getSession().createQuery(
				"from Course from name = :name").setParameter("name", name).uniqueResult();
	}
	...
	public List<Course> findByIdTeacher(Long idTeacher) {
		...
		return getSession().createQuery(
				"from Course c join c.teacher t where t.idTeacher = :idTeacher").setParameter("idTeacher", idTeacher).list();
	}
